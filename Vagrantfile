Vagrant.configure("2") do |config|
    ...
    config.vm.define "k8smaster" do |k8smaster|
         ...
         k8smaster.vm.network "private_network", ip: "192.168.50.aa"
    ...
    config.vm.define "k8snode1" do |k8snode1|
        ...
        k8snode1.vm.network "private_network", ip: "192.168.50.bb"
    ...
    config.vm.define "k8snode2" do |k8snode2|
        ...
        k8snode2.vm.network "private_network", ip: "192.168.50.cc"
    ...
    config.vm.define "devbuild" do |devbuild|
        ...
        devbuild.vm.network "private_network", ip: "192.168.20.dd"
